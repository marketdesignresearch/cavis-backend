...
class VCGAPITests {
    ...
    fun `Should handle LLG bids correctly`() {
        ...
        mvc.perform(post("/auctions/$id/close-round"))
                ...
                .andExpect(jsonPath("$.auction.rounds[0].mechanismResult.allocation.$b1Id.bundle[0].good").value(AId))
                .andExpect(jsonPath("$.auction.rounds[0].mechanismResult.allocation.$b1Id.bundle[0].amount").value(1))
                .andExpect(jsonPath("$.auction.rounds[0].mechanismResult.allocation.$b2Id.value").value(10))
                .andExpect(jsonPath("$.auction.rounds[0].mechanismResult.allocation.$b2Id.bundle[0].good").value(BId))
                .andExpect(jsonPath("$.auction.rounds[0].mechanismResult.allocation.$b2Id.bundle[0].amount").value(1))
